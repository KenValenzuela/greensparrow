    ...
    <div style={styles.wrapper}>
      ...
      <div style={styles.page}>
        ...
        <div style={styles.profile}>
          ...
          />
          <h1 style={styles.name}>Mickey</h1>
